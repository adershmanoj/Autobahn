...
$(function () { // wait for document ready
    ...
    $('.s08 .billboard').click(function(event) {
      event.preventDefault();
      $('#joona').modal({
        fadeDuration: 250
      });
    });
    $('#day1').click(function(event) {
      event.preventDefault();
      $('#day1_schedule').modal({
        fadeDuration: 250
      });
    });
    $('#day2').click(function(event) {
      event.preventDefault();
      $('#joona').modal({
        fadeDuration: 250
      });
	...
	if($(window).width() > 1024){
		$('.section.info.normal .billboard').hover(function(){
			...
			{
				$(this).parent().find('.info-box').addClass('hide');
                $(this).parent().find('.dialog').removeClass('hide'); 
				$(this).parent().find('dialog').addClass('shown'); 
			}
            ...
            $(this).parent().find('.info-box').removeClass('hide');
            $(this).parent().find('.dialog').addClass('hide');
	...
	new ScrollMagic.Scene({triggerElement: ".section.s01.a", duration: "1500%"})
